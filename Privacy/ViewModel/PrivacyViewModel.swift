    ...
    func transform(input: Input) -> Output {
        ...
        let protocolText = Observable.create {[self] observer in
            ...
            observer.onNext("""
                            ...
                            采取各种安全措施来保护您的个人信息.我们重视青少年及儿童的个人信息保护,若您是未满18周岁的未成年人,请在监护人的指导下阅读并同意以上协议以及《儿童及青少年个人信息保护法规》.
        ...
        let refuse = input.refuse.map { [self] _ in
            ...
            else
            {
                ...
                protocolObserver.onNext("""
                                            如果您不同意《人人讲用户协议》和《人人讲隐私政策》以及《儿童及青少年个人信息保护法规》,很遗憾我们将无法为您提供服务,你需要同意以上协议后,才能使用人人讲
